...
if ( isset($_POST['initfields']) ) {
    ...
    include_once GALETTE_BASE_PATH . 'includes/fields_defs/members_fields_cats.php';
    $fc = new FieldsConfig($zdb, Adherent::TABLE, $members_fields, $members_fields_cats, true);
    $res = $fc->installInit();
    if ( $res === true ) {
